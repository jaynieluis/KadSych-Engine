...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		songPosBG.visible = (ClientPrefs.songPosition);
		add(songPosBG);
			
		songPosBar = new FlxBar(songPosBG.x + 4, songPosBG.y + 4, LEFT_TO_RIGHT, Std.int(songPosBG.width - 8), Std.int(songPosBG.height - 8), this,
			'songPositionBar', 0, 1);
		songPosBar.scrollFactor.set();
		songPosBar.visible = (ClientPrefs.songPosition);
		...
		songName.visible = (ClientPrefs.songPosition);
		add(songName);
		...
		botplayTxt = new FlxText(400, songPosBG.y + 500, FlxG.width - 800, "BOTPLAY", 38);
		botplayTxt.setFormat(Paths.font("vcr.ttf"), 38, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function noteMiss(daNote:Note):Void { //You didn't hit the key and let it go offscreen, also used by Hurt Notes
		...
		if (ClientPrefs.shakeOnMiss)
			FlxG.camera.shake(0.0000, 0.0, null, true, X);
